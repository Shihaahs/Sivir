...
public class CustomerController {
    ...
    public APIResult<PageResult<Sorder>> getAllSorderByCustomerId(PageRequestDTO pageRequestDTO) {
    ...
    public APIResult<Integer> addSorder(Sorder sorder) {
    ...
    public APIResult<Integer> cancelSorder(Sorder sorder) {
